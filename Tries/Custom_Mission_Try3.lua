...
local function read_mission()
    ...
    item:x(math.floor(27.1649942 * 1e7))
    item:y(math.floor(80.3686842 * 1e7))
    item:z(200)
    ...
    -- item:x(math.floor(27.267648  * 1e7))
    -- item:y(math.floor(80.4668107 * 1e7))
    -- item:z(250)
...
function update()
    ...
    if mission_loaded then
        -- If mission is loaded, just return to keep it running
